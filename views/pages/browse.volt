...
<div style="width: 1024px; margin: 0 auto;">
    <table id="grid-selection" class="table table-condensed table-hover table-striped">
        ...
        <tr>
            ...
            <th data-column-id="intro" data-width="35%" data-sortable="false">Content</th>
            <th data-column-id="name" data-sortable="false">User</th>
            <th data-column-id="published" data-formatter="published" data-sortable="false">Publish</th>
